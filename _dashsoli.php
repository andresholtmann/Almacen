        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                            ...
                            <form role="form" method="post" action="">
                               ...
                               <div class="form-group">               
                                ...
                                <div class="form-group">
                                <label>Ingresar Justificacíon:</label>
                                <textarea class="form-control" name="kar_desc" required minlength="20" maxlength="500" id="exampleFormControlTextarea1" rows="6" placeholder="Justificaci&oacute;n"></textarea>
                                 <!--<input class="form-control" type="text" name="nkar_desc" size="500" maxlength="500" id="exampleFormControlTextarea1" placeholder="Justificaci&oacute;n" required> -->
                                <input type="hidden" name="num_kar" class="form-control" value="0" id="exampleInputEmail1" placeholder="No. de Salida"> 
                                </div>                                
                                  <div class="form-group"> <!-- Date input -->
                                    <label class="control-label" for="date">Fecha de Solicitud</label>
                                    <input class="form-control" type="date" id="date" name="fecho_kar" value="<?php echo $feiyo2;?>"/>
                                  </div> 
