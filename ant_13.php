...
?>        
   <div id="yesprint" class="nolo2">    
        <div id="yesprint" class="f"><?php echo $row['cod_pro'];?></div>
        <div id="yesprint" class="g"><?php echo $row['pro_pro'];?></div>
        <div id="yesprint" class="h"><?php echo $row['cat'];?></div>
        <div id="yesprint" class="i"><?php echo $row['pres_pres'];?></div>
        <div id="yesprint" class="j">
                                                  
                            <?php echo $totoro;?>
       
       </div>     
        <div id="yesprint" class="k">Q. <?php echo number_format($row['cosprod_pro'], 2);?></div>    
        <div id="yesprint" class="kk">Q. <?php $finaluko = $totoro * $row['cosprod_pro'] ;  echo number_format($finaluko, 2);?></div>                          
   </div> 
