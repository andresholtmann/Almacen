...
<table width="850px"  cellpadding="6" class="fonta" cellspacing="10" border="0">
                   <tbody>
						<?php   
                         $query = "SELECT id_mov,fac_mov,tip_mov,prod_mov,preu_mov,cant_mov,id_pro,cod_pro,codrengasto_pro,pro_pro,pres_pro,id_pres,pres_pres FROM mov_".$tutu." inner join prod_".$tutu." on prod_mov = id_pro inner join pres_".$tutu." on pres_pro = id_pres where tip_mov like 'ING' and fac_mov like '".htmlspecialchars($_GET['fac'])."' order by id_mov DESC";
                        ...
                        if($result) {
                         ...
                         ?> 
                            ...
                            <td class="_5"></td>                                 
                            <td class="_6">&nbsp;Q. <?php echo number_format($row['preu_mov'], 2);?></td>
                    ...
                    <tfoot>
                            ...
                            <td >Q. <?php echo number_format($tota, 2);?></td>   
                          <td></td>                                  
                            <td >
