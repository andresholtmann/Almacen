...
if( isset($_GET['del'])  )
    ...
    $querysp = "SELECT id_mov,tip_mov,prod_mov,cant_mov,preu_mov,st_mov,fech_mov FROM mov_".$tutu." where prod_mov like '".$prod."' and st_mov like '1' and fech_mov between '2017-07-31' and '".htmlspecialchars($_GET['pro'])."' order by id_mov ASC";
                                $resultsp = mysqli_query($mysqli, $querysp) or trigger_error("Query Failed! SQL: $querysp - Error: ". mysqli_error($mysqli), E_USER_ERROR);
                                $totorop = 0 ;
                                if($resultsp) {
                            ...
                            echo "<br><br><br><br><br><br><br><br><br>" ;                            
                                    ...
                                    echo $rowsp['cant_mov'];                                    
                                        ...
                                        if ($movop == 'INV') {
                                            ...
                                            $totorop = $totorop + $rowsp['cant_mov'];
                                    ...
                                    $Preprecio = $totorop * $rowsp['preu_mov'] ;
                                    $pretotal = $pretotal + $Preprecio ; 
                                    }
                            echo "<br><br><br><br><br><br><br><br><br>" ;                            
                                        echo "procesando" ;   
                                    
                                    
                                    $costofnal = $pretotal / $totorop ;
                     ...
                     $sql = "UPDATE prod_alma SET cosprod_pro='".$costofnal."' where id_pro like '".htmlspecialchars($_GET['pro'])."' ";    
        ...
        if( isset($_POST['ingresano']) )
            ...
            $pretotal = 0 ;
             ...
             $coun=$check->num_rows;     
                     ...
                     $add = "INSERT INTO mov_".$tutu." (fac_mov,tip_mov,prod_mov,cant_mov,preu_mov,st_mov,fech_mov,useing) VALUES ('$_POST[fac_mov]','ING','$_POST[prod_mov]','$_POST[cant_mov]','$_POST[preu_mov]','1','$_POST[fech_mov]','$ide')";
                        if ($mysqli->query($add) === TRUE) 
                            ...
                            $pivo = $_POST['fac_mov'] ;
                              ...
                              $querysp = "SELECT id_mov,tip_mov,prod_mov,cant_mov,preu_mov,st_mov,fech_mov FROM mov_".$tutu." where prod_mov like '".$prod."' and st_mov like '1' and fech_mov between '2017-07-31' and '".$feiyo2."' order by id_mov ASC";
                                $resultsp = mysqli_query($mysqli, $querysp) or trigger_error("Query Failed! SQL: $querysp - Error: ". mysqli_error($mysqli), E_USER_ERROR);
                                $totorop = 0 ;
                                if($resultsp) {
                                while($rowsp = mysqli_fetch_assoc($resultsp)) {
                     ...
                     $sql = "UPDATE prod_alma SET cosprod_pro='".$costofnal."' where id_pro like '".$prod."' ";    
                    if ($mysqli->query($sql) === TRUE) {
                    echo "Record updated successfully";
                    } else {
                        echo "Error updating record: " . $mysqli->error;
         ...
         <?php                    
            ...
            {	 
                    ...
                    $sql = "UPDATE mov_".$tutu." SET  prov_fac='$_POST[prov_fac]', num_fac='$_POST[num_fac]', fecho_fac='$_POST[fecho_fac]', useing='$ide' WHERE id_fac like '".$_POST['id_fac']."' ";    
                    if ($mysqli->query($sql) === TRUE) {
                    echo "Record updated successfully";
        ?>
                <script language="Javascript">
            ...
            <style>
                .decu{
                    ...
                    color: white;
						...
						<?php   
                         $query = "SELECT id_fac,prov_fac,num_fac,stat_fac,descu_fac,id_prov,n_prov,des_prov,nit_prov,fecho_fac,DATE_FORMAT(fecho_fac,'%d/%m/%Y') AS niceDate FROM fac_".$tutu." inner join prov_".$tutu." on prov_fac = id_prov where id_fac like '".htmlspecialchars($_GET['fac'])."'";
                        $result = mysqli_query($mysqli, $query) or trigger_error("Query Failed! SQL: $query - Error: ". mysqli_error($mysqli), E_USER_ERROR);
                        if($result) {
                            while($row = mysqli_fetch_assoc($result)) {
                                $fecho=$row['fecho_fac'];
            ...
            <div class="alert-message alert-message-info">
                <h4>Agregar Producto a la Factura</h4>
                     <form class="form-inline" method="post" action="?alm=_7&fac=<?php echo "".htmlspecialchars($_GET['fac'])."";?>">
                      <div class="form-group">
                        <section id="intro" >      
                                <select name="prod_mov" class="form-control" required >
                                    <?php                    
                                        $queryada = "SELECT id_pro,cod_pro,pro_pro,cosprod_pro,st_pro FROM prod_".$tutu." where st_pro like '0' order by cod_pro ASC ";
                      ...
                      <div class="form-group">
                        <input type="text" name="cant_mov" class="form-control" id="exampleInputEmail2" required placeholder="Cantidad">
                      </div>
                      <div class="form-group">
                        <input type="text" name="preu_mov" class="form-control" id="exampleInputEmail2" required placeholder="Pre. Unitario">
              ...
              <table id="myTable" class="table table-striped table-bordered">
                  ...
                  <th>&nbsp;</th>
                    ...
                    <tbody>
                        ...
                        if($result) {
                         ...
                         ?> 
                            ...
                            <td class="alimano">Q. <?php echo number_format($row['preu_mov'], 3);?></td>
                            ...
                            <td class="alimano">
                                ...
                                {                           
                                        ?> 
                                            <a class="btn btn-danger btn-info-full" href="?alm=_7&del=<?php echo $row['id_mov'];?>&fac=<?php echo "".htmlspecialchars($_GET['fac'])."";?>&pro=<?php echo $row['cod_pro'] ;?>" target="_self"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></a>  
                                        <?php                        
                                }
                                        ?>
                                    </td>                                
                    ...
                    <tfoot>
                            ...
                            <td></td>
                            <td></td>                                
                            <td class="alimano">Q. <?php echo number_format($tota, 3);?></td>                                
                            <td class="alimano">
                                <?php                    
                                if ($st == 0 )
                                {
